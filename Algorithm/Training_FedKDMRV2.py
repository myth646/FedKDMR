...
def FedKDMRV21(args, net_glob, dataset_train, dataset_test, dict_users):
    net_glob.train()
    ...
    for iter in range(args.epochs):
        ...
        KD_alpha = get_dynamic_KD_alpha(iter, args.first_stage_bound, args.KD_alpha, args.Dynamic_KD_power)
        for i, idx in enumerate(idxs_users):
            ...
            local = LocalUpdate_KD_step1_d(args=args, dataset=dataset_train, idxs=dict_users[idx])
...
def FedKDMRV22(args, net_glob, dataset_train, dataset_test, dict_users):
    net_glob.train()
...
def Fed2WKDMRV21(args, net_glob, dataset_train, dataset_test, dict_users):
    net_glob.train()
...
def Fed2WKDMRV22(args, net_glob, dataset_train, dataset_test, dict_users):
    net_glob.train()
